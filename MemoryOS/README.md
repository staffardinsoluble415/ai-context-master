...
memoryos store --category decisions --title "Choice" --content "We chose X because..."

# Search
memoryos search "query"
memoryos vsearch "semantic query"    # vector search

# Knowledge graph
memoryos graph                       # vault stats
memoryos context "topic"             # graph-aware context retrieval

# Session lifecycle
memoryos checkpoint --working-on "task"
memoryos sleep "what I did" --next "what's next"
memoryos wake                        # restore context on startup
```

---

*Managed by [MemoryOS](https://memoryos.dev)*
